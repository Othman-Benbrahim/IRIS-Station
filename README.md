...
> _À définir._ Ajoutez un fichier `LICENSE` à la racine. Une licence permissive comme **MIT** est un choix courant pour ce type de projet :

```
MIT License — Copyright (c) <année> <votre nom>
```
